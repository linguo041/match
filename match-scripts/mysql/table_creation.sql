...
create table match_pankou (
  ...
  origin_h_win decimal(5,3),
  origin_a_win decimal(5,3),
  origin_pk decimal(5,3),
  main_h_win decimal(5,3),
  main_a_win decimal(5,3),
  main_pk decimal(5,3),
  current_h_win decimal(5,3),
  current_a_win decimal(5,3),
  current_pk decimal(5,3),
...
create table match_euro_state (
  ofn_match_id bigint not null,
  avg_win decimal(5,3),
  avg_draw decimal(5,3),
  avg_lose decimal(5,3),
...
create table match_company_euro (
  ofn_match_id bigint not null,
  company varchar(40) not null,
  origin_win_pl decimal(8,3),
  origin_draw_pl decimal(8,3),
  origin_lose_pl decimal(8,3),
  main_win_pl decimal(8,3),
  main_draw_pl decimal(8,3),
  main_lose_pl decimal(8,3),
  current_win_pl decimal(8,3),
  current_draw_pl decimal(8,3),
  current_lose_pl decimal(8,3),
...
create table football.teams (
	ofn_team_id bigint not null,
	team_name varchar(40) not null,
	team_name_en varchar(40),
	national int,
	city varchar(40),
	field varchar(40),
	city_team_id1 bigint,
	city_team_id2 bigint,
	ft_contry varchar(50),
	ft_name varchar(50),
	ft_point int,
	primary key (ofn_team_id)
) ENGINE=InnoDB;
