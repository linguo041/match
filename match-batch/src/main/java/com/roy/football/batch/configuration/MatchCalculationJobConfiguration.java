...
import com.roy.football.batch.lancher.MatchCalculationJobLancher;
...
public class MatchCalculationJobConfiguration {
	...
	@Bean
    public Job matchCalculateJob(JobBuilderFactory jobs, Step s1) {
	...
	@Bean MatchCalculationJobLancher matchCalculationJobLancher() {
		return new MatchCalculationJobLancher();
	}
}
